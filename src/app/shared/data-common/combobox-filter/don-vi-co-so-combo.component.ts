...
const VALUE_ACCESSOR: Provider = {
    ...
    useExisting: forwardRef(() => DonViCoSoComboComponent),
    multi: true,
};

@Component({
    selector: 'don-vi-co-so-combo',
    template: `
...
export class DonViCoSoComboComponent extends AppComponentBase implements OnInit, OnDestroy, ControlValueAccessor {
    ...
    constructor(
        ...
        this.$maTinh.pipe(
            switchMap((ma) => {
                if (ma) {
                    return this._dataCommonService.getComboboxDataObs('donvicoso_' + ma, this._comboboxService.comboBoxData(0, ma));
                } else {
                    return of([]);
                }
            }),
