...
import { ComboboxItemDto, DanhMucNgheNghiepServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class NgheNghiepComboComponent extends AppComponentBase implements OnInit, ControlValueAccessor {
    ...
    constructor(
        ...
        private  _nghenghiepService: DanhMucNgheNghiepServiceProxy,
    ) {
        super(injector);
    }

    ngOnInit() {
        this._comboboxService.getComboboxDataObs('nghenghiep', this._nghenghiepService.comboBoxData())
