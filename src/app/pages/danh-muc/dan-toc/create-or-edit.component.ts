...
import {DanhMucDanTocServiceProxy, DanhMucDanTocDto} from '@shared/service-proxies/service-proxies';
...
export class CreateOrEditDanTocComponent extends ModalComponentBase implements OnInit {
    @Input() dataItem: DanhMucDanTocDto;
