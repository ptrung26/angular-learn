...
@Component({
    selector: 'vgc-co-so-y-te',
    templateUrl: './vgc-co-so-y-te.component.html',
    encapsulation: ViewEncapsulation.Emulated,
})
export class VgcCoSoYTeComponent extends AppComponentBase implements OnInit, OnChanges {
    @Input() maTinh: string;
    ...
    vgccsytscreeningtestlabel = [];
    vgccsytscreeningtestpositivelable = [];
    ...
    loadData(): void {
        ...
        this.vgccsytscreeningtestlabel = ['0', '0', '0', '0'];
        this.vgccsytscreeningtestpositivelable = ['0', '0', '0', '0'];
        ...
        this.groupByMonth = [];
        this.groupByMonthSort = [];
        this.vgccsytscreeningtestlabel = [];
        this.vgccsytscreeningtestpositivelable = [];
        this._dataService.dashboardTongHop(tongHopRequest)
            ...
            .subscribe(result => {
                ...
                //Group tháng
                let sortNgayLamXetNghiem = _.sortBy(_.cloneDeep(this.dataTongHop), 'antiHCV_NgayLam');
                this.groupByMonth = this.groupByKey(sortNgayLamXetNghiem, 'antiHCV_ThangLam');
                (Object.keys(this.groupByMonth)).forEach(x => {
                    this.groupByMonthSort.push(
                        {
                            thang: x,
                            soBenhNhan: this.groupByMonth[x].length,
                            soDuongTinh: this.groupByMonth[x].filter(x => x.antiHCV_KetQua === KET_QUA_XET_NGHIEM.DUONG_TINH).length,
                        },
                    );
                });
                ...
                let vgccsytscreeningtestNam = _.cloneDeep(this.dataTongHop).filter(x => x.gioiTinh === GIOI_TINH.NAM).length;
                let vgccsytscreeningtestNu = _.cloneDeep(this.dataTongHop).filter(x => x.gioiTinh === GIOI_TINH.NU).length;
                if (this.dataTongHop.length > 0) {
                    this.vgccsytscreeningtestlabel = [];
                    this.vgccsytscreeningtestlabel.push(vgccsytscreeningtestNam);
                    let vgccsytscreeningtestNamPercent = (vgccsytscreeningtestNam * 100 / this.dataTongHop.length).toFixed(1);
                    this.vgccsytscreeningtestlabel.push(vgccsytscreeningtestNamPercent);
                    this.vgccsytscreeningtestlabel.push(vgccsytscreeningtestNu);
                    this.vgccsytscreeningtestlabel.push((100 - parseFloat(vgccsytscreeningtestNamPercent)).toFixed(1));
                }
                ...
                let vgccsytscreeningtestpositiveNam = dataScreeningPositive.filter(x => x.gioiTinh === GIOI_TINH.NAM).length;
                let vgccsytscreeningtestpositiveNu = dataScreeningPositive.filter(x => x.gioiTinh === GIOI_TINH.NU).length;
                if (this.dataTongHop.length > 0) {
                    this.vgccsytscreeningtestpositivelable = [];
                    this.vgccsytscreeningtestpositivelable.push(vgccsytscreeningtestpositiveNam);
                    let vgccsytscreeningtestpositiveNamPercent = (vgccsytscreeningtestpositiveNam * 100 / dataScreeningPositive.length).toFixed(1);
                    this.vgccsytscreeningtestpositivelable.push(vgccsytscreeningtestpositiveNamPercent);
                    this.vgccsytscreeningtestpositivelable.push(vgccsytscreeningtestpositiveNu);
                    this.vgccsytscreeningtestpositivelable.push((100 - parseFloat(vgccsytscreeningtestpositiveNamPercent)).toFixed(1));
                }
                ...
                this.getChart(this.dataTongHop, this.dataTongHopBHYT, topMonthData, this.tongSangLoc, this.sangLocDuongTinh, this.VGC_XetNghiemKhangDinh, this.VGC_XetNghiemKhangDinhChuanDoan);
                abp.ui.clearBusy();
            });
    }
    ...
    getChart(dataTongHop, dataTongHopBHYT, topMonthData, tongSangLoc, sangLocDuongTinh, VGC_XetNghiemKhangDinh, VGC_XetNghiemKhangDinhChuanDoan) {
        am4core.ready(function() {
            am4core.useTheme(am4themes_animated);
            //#region Số người xét nghiệm

            let chartScreeningTest = am4core.create('vgc-csyt-screening-test', am4charts.XYChart);
            ...
            //#region Số người xét nghiệm dương tính
            ...
            let chartScreeningPositive = am4core.create('vgc-csyt-screening-test-positive', am4charts.XYChart);
            ...
            //#region Kết quả sàng lọc theo tháng

            let chartMonth = am4core.create('vgc-csyt-chart-month', am4charts.XYChart);
            ...
            let chartSexTest = am4core.create('vgc-csyt-chart-sex-cag-test', am4charts.PieChart);
            ...
            let chartOldTest = am4core.create('vgc-csyt-chart-old-cag-test', am4charts.XYChart);
            chartOldTest.data = [{
                'old': '<15',
            ...
            let chartSexPositive = am4core.create('vgc-csyt-chart-sex-cag-positive', am4charts.PieChart);
            ...
            let chartOldPositive = am4core.create('vgc-csyt-chart-old-cag-positive', am4charts.XYChart);
            ...
            let chartBeginTreatment = am4core.create('vgc-csyt-chart-beingtreatment', am4charts.PieChart);
            ...
            // let chartSexCure = am4core.create('vgc-csyt-chart-sex-cure', am4charts.PieChart);
            ...
            //
            // let chartOldCure = am4core.create('vgc-csyt-chart-old-cure', am4charts.XYChart);
            // chartOldCure.data = [{
            //     'old': '<15',
            ...
            let chartCure = am4core.create('vgc-csyt-chart-cure', am4charts.PieChart);
            // let sexCureDate = dataTongHop.filter(x => x.viemGanCMan === true && (x.ngayKetThuc_ViemGanC !== null && x.ngayKetThuc_ViemGanC !== undefined) && x.hcvarN_LanCuoi_Nguong === NHOM_NGUONG.DUOI_NGUONG && x.soNgayDieuTriViemGanC > 83);
            ...
            let chartMultiLevel = am4core.create('vgc-csyt-chart-multi-level', am4charts.XYChart);
            ...
            let chartTreatmentInsurance = am4core.create('vgc-csyt-chart-treatment-insurance', am4charts.PieChart);
